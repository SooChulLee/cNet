...
$(function () {
	var colModel = [
		...
		{ title: "디폴트", width: 80, dataIndx: "default_used",
			...
			render: function(ui) {
				return fn.getValue("usedCode",[ui.rowData["default_used"]]);
			},
		},
		{ title: "정렬", width: 80, dataIndx: "order_used",
			...
			render: function(ui) {
				return fn.getValue("usedCode",[ui.rowData["order_used"]]);
			},
		},
	...
	var baseObj = getBaseGridOption("search_code", "N", "N", "Y", "Y");
...
%>
	...
	$("#regi button[name=modal_regi]").click(function() {
		...
		$.ajax({
			type: "POST",
			url: "remote_search_code_proc.jsp",
			async: false,
	...
	<div class="row titleBar border-bottom2">
		...
		<ol class="breadcrumb" style="float:right;">
			 ...
			 <li class="active"><strong>조회 코드</strong></li>
		</ol>
	</div>
	<!--title 영역 끝 -->
			...
			<div class="panel-heading">
				<div class="panel-options">
					<ul class="nav nav-tabs">
						...
						<li class="active"><a href="search_code.jsp">조회 코드</a></li>
					...
					<div class="modal-content animated fadeIn">
						<form id="regi">
							<div class="modal-header">
								...
								<h4 class="modal-title">조회 코드 등록</h4>
							</div>
